...
function show_filter_price2(){
    ...
    .then((res)=>{
        var proArr = res.data;
        for(var pro of proArr){
            if(pro.type.for=="stoneCarving" &&  pro.price>30 && pro.price<=100){
                document.getElementById("products__list-stoneCarving").innerHTML+=`
                <div class ="products_stoneCarving">
            <div class="img_stoneCarving">
                <img src="${pro.image}" alt="">
...
function show_filter_price3(){
    ...
    .then((res)=>{
        var proArr = res.data;
        for(var pro of proArr){
            if(pro.type.for=="stoneCarving" &&  pro.price>100 && pro.price<=150){
                document.getElementById("products__list-stoneCarving").innerHTML+=`
                <div class ="products_stoneCarving">
            <div class="img_stoneCarving">
                <img src="${pro.image}" alt="">
...
function show_filter_price4(){
    ...
    .then((res)=>{
        var proArr = res.data;
        for(var pro of proArr){
            if(pro.type.for=="stoneCarving" &&  pro.price>150){
                document.getElementById("products__list-stoneCarving").innerHTML+=`
                <div class ="products_stoneCarving">
            <div class="img_stoneCarving">
                <img src="${pro.image}" alt="">
